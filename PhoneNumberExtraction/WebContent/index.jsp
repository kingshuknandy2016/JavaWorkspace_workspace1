...
<body>
	<div class="form-style-5">
		<form method="post" action="MasterController">
			<fieldset>
				<legend>
					<span class="number">1</span> Country
				</legend>
				<input type="text" name="field1" id="pat1" placeholder="Country*">
			</fieldset>
			<fieldset>
				<legend>
					<span class="number">2</span>Company
				</legend>

				<input type="text" name="field2" id="pat2" placeholder="Company*">
			</fieldset>
