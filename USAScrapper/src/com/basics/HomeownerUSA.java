...
public class HomeownerUSA {
	...
	/*  File pathToBinary = new File("C:\\Program Files (x86)\\Mozilla Firefox\\Firefox.exe");
	 ...
	 HSSFSheet sheet1 = workbook.getSheet("Sheet2"); 
	 ...
	 driver.findElement(By.id("login")).sendKeys("jchamberlin");
	 driver.findElement(By.id("pass")).click();
	 driver.findElement(By.id("pass")).sendKeys("jchamberlin05");
	 driver.findElement(By.xpath("(//input[@type='submit'])[1]")).click(); //driver.findElement(By.id("member-resources")).findElement(By.xpath("(//a[text()='Consumer Lists'])[1]")).click();
	 ...
	 driver.get("http://salesdatalist.com/search/b2c");
