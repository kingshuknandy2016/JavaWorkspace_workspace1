...
public class ContactInformation {
    ...
    LaunchApplication.applicationLaunch();
     ContactInformation co=new ContactInformation();
     co.ContactInformationCheck();
	}
	
	public void ContactInformationCheck() throws FileNotFoundException {
		 
		//---------TC001_Default salutation
		ModuleName = "ContactInformation";
		TestId = "TC001_Check_Title";
		Expected = Parameter.GetInput(ModuleName, TestId, 2);
		try {
			config.driver.findElement(OR.GetLocator("Authentication", "UserName")).sendKeys("qa2@velloe.com");
